...
class UARegionScraper:
    def __init__(self):
        self.base_url = "https://www.ua-region.com.ua/kved/01.13"
        self.output_file = "companies_01_13.csv"
    ...
    def get_total_pages(self):
        ...
        # Якщо не вдалося визначити кількість сторінок
    ...
    def log_progress(self):
        ...
        if not self.start_time or not self.total_companies:
            return
